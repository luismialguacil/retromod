        ...
        <div class="row">
            ...
            <div class="col-12 col-lg-6 order-1 order-lg-2 p-5">
                ...
                <form>
                    ...
                    <input type="text" id="user" class="fadeIn third" name="user" placeholder="Nombre de usuario">
                    <input type="text" id="pass" class="fadeIn third" name="pass" placeholder="Contraseña">
                    <input type="text" id="pass2" class="fadeIn third" name="pass2" placeholder="Repetir contraseña">
